    ...
    <View>
      ...
      >
        <View className="flex flex-col justify-center h-screen lg:items-start sm:items-center lg:pl-32 backdrop-blur-[8px]">
          <View className="flex flex-col justify-center items-center bg-tender-surrender/70 dark:bg-secondary/85 py-8 sm:rounded-3xl">
            <Text className="text-secondary dark:text-white text-2xl font-main font-bold">
              Welcome to Derailed!
            </Text>
            <Text className="text-secondary dark:text-gray-300 text-xl font-light font-main pb-3 italic">
            ...
            <View className="black-glass-50 dark:white-glass-50 gap-5 xl:gap-10 xl:p-10 p-7 rounded-2xl">
              ...
              <View className="flex items-center gap-3 w-full">
                ...
                <Link href="/(accounts)/register" className="w-full">
                  <View className="border border-secondary dark:border-white p-2 w-full rounded-lg">
                    <Text className="text-secondary text-center dark:text-white text-lg font-main">
                      Register
                    </Text>
                  </View>
                </Link>
